<?php namespace App\Http\Controllers;
	...
	class AdminSilatController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Img','name'=>'img','type'=>'text','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Img","name"=>"img","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
