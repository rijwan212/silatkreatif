<?php namespace App\Http\Controllers;
	...
	class AdminWorkshopController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Facilitator","name"=>"facilitator"];
			...
			$this->form[] = ['label'=>'Facilitator','name'=>'facilitator','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Facilitator","name"=>"facilitator","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
