                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="images/portfolio/slider1.jpg" alt="">
                        ...
                        <div class="item">
                            <img src="images/portfolio/slider2.jpg" alt="">
                            <div class="carousel-caption">
                        ...
                        <div class="item">
                            <img src="images/portfolio/slider3.jpg" alt="">
                            <div class="carousel-caption">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    ...
                    <div class="row">
                    @foreach($silat as $silat)
                        <div class="col-xs-6 col-sm-6 col-md-4 portfolio-item branded logos">
                            <div class="portfolio-wrapper">
                                <div class="portfolio-single">
                                    <div class="portfolio-thumb">
                                        <img src="images/{{ $silat->img }}" class="img-responsive" alt="">
                                    </div>
                                    <div class="portfolio-view">
                                        <ul class="nav nav-pills">
                                            <li><a href="{{ url('situs/'.$silat->id) }}"><i class="fa fa-link"></i></a></li>
                                            <li><a href="images/portfolio/s1.jpg" data-lightbox="example-set"><i class="fa fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
