                         ...
                         <div class="col-md-12 col-sm-12">
                            <div class="single-blog blog-details two-column">
                                <div class="post-thumb">
                                    <a href="/{{ $post->image }}"><img src="/{{ $post->image }}" class="img-responsive" alt=""></a>
                                    ...
                                    <div class="author-profile padding">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <span>Website:<a href="www.jooomshaper.com"> www.dhimasganteng.com</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
