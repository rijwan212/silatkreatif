        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 padding-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0ms">
                    ...
                    <p>Kegiatan dari setiap event yang dilaksanakan atas kerjasama kami bersama<br /> Komunitas pecinta silat dan forum kebudayaan betawi</p>
                    <ul class="elements">
                    ...
                    <div class="portfolio-wrapper">
                        <div class="portfolio-single">
                            <div class="portfolio-thumb">
                                 <iframe width="280" height="295" src="{{ $videos->url }}" frameborder="0" allowfullscreen></iframe>
                            </div>
